...
use crate::geometry_types::{Geometry2D, Mesh3D, OpeningCutout, Point2D, Polygon2D, WallGeometry};
use crate::schema_types::{SchemaDoor, SchemaWall, SchemaWindow, WallType};
use glam::{Vec2, Vec3};
...
mod tests {
    use super::*;
    use crate::schema_types::WallLayer;
